...
async function _load() {
  const { rows } = await query(
    'SELECT user_id, email, name, role, rep_code, phone, field_app_access, portal_access, is_active FROM users WHERE is_active = TRUE AND rep_code IS NOT NULL ORDER BY rep_code'
  );
